...
// só muda de cor por seção e de tamanho (grande no cabeçalho, pequena
// como marca-d'água no canto de cada bloco de texto).
...
// Marca-d'água pequena, sempre no canto superior direito do bloco.
...
export default function Landing({ onEntrar }) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fdfbf7', fontFamily: theme.fontSerif }}>

      {/* Header fixo, sempre marfim, com acesso pra quem já tem conta */}
      ...
      {/* Hero */}
      <div style={{ background: '#3d0012', padding: '30px 24px 40px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 520, margin: '0 auto' }}>
          ...
          <div style={{ fontFamily: theme.fontTitle, fontWeight: 700, fontSize: 30, lineHeight: 1.25, color: '#f2e9d8', marginBottom: 22 }}>
            A tese certa, na hora da peça.
          </div>
          <button onClick={onEntrar} style={{ background: 'transparent', border: '1px solid #e8c98a', color: '#e8c98a', fontSize: 13, padding: '10px 22px', cursor: 'pointer', fontFamily: theme.fontSerif }}>
            Conhecer o acervo
          </button>
        </div>
      </div>
      ...
      {/* Por que existe */}
      <div style={{ background: '#f6ede0', padding: '38px 24px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ background: '#fdfbf7', borderTop: '4px solid #a9812e', padding: '38px 24px', position: 'relative', overflow: 'hidden' }}>
      ...
      {/* Para quem é */}
      <div style={{ background: '#fdfbf7', borderTop: '4px solid #7a1128', padding: '38px 24px', position: 'relative', overflow: 'hidden' }}>
      ...
      {/* Do acervo, agora */}
      <div style={{ background: '#fdfbf7', borderTop: '4px solid #2c4a6e', padding: '38px 24px 48px', position: 'relative' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 520, margin: '0 auto' }}>
          ...
          <div style={{ borderTop: '2px solid #7a1128', paddingTop: 8, marginBottom: 28 }}>
            <div style={{ fontFamily: theme.fontSerif, fontSize: 14, color: '#2c241b' }}>
