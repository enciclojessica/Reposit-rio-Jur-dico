...
export const TEMAS_CONFIG = {
  ...
  manuscrito: {
    ...
    bg: '#f5f0e8', bgDeep: '#ede8dc', surface: '#ede8dc', raised: '#ffffff',
    border: '#c8bfad', borderGold: '#5c3d1e44',
    gold: '#5c3d1e', goldDark: '#3d2810',
    cream: '#1a1208', muted: '#7a6a52', text: '#1a1208', textSub: '#3a2e20',
    civel: '#1e3a8a', penal: '#991b1b', info: '#065f46', doutrina: '#581c87',
    error: '#991b1b', success: '#065f46',
    cardBg: '#ffffff', inputBg: '#faf5ed', logoBg: '#ffffff',
    shadow: '0 4px 20px #00000018', toastOk: '#f0fdf4', toastErr: '#fef2f2', btnMutedBg: '#ede8dc',
